          ...
          <Link href="/login">
            <button
              ...
              style={{
                ...
                boxShadow:
                  '0 4px 16px rgba(99,102,241,0.3), inset 0 1px 0 rgba(255,255,255,0.12)',
              }}
            >
              Sign In
        ...
        <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mx-auto max-w-3xl">
            <h1
              ...
              style={{
                background:
                  'linear-gradient(135deg, #ffffff 0%, #e2e8f0 40%, #c4b5fd 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                lineHeight: 1.15,
              }}
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                ...
                <p
                  className="relative text-[12px] leading-relaxed"
                  style={{ color: '#475569' }}
                >
                  {feature.description}
                </p>
