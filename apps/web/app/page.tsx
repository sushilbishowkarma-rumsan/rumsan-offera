// // /**
// //  * Landing Page - /
// //  * The public-facing homepage for Offera.
// //  * Redirects authenticated users to the dashboard.
// //  * Shows a marketing-style landing for unauthenticated visitors.
// //  */
...
//  // If already logged in, send them to the dashboard immediately
//   useEffect(() => {
//     if (isAuthenticated) {
