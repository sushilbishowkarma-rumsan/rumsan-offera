...
export default function UserProfilePage({ params }: PageProps) {
  ...
  const { data: wfhHistory = [], isLoading: wfhLoading } =
    useUserWfhHistory(userId);

  const [historyPage, setHistoryPage] = useState(1);
  const HISTORY_PAGE_SIZE = 5;

  const isLoading =
    profileLoading || balancesLoading || historyLoading || wfhLoading;
              ...
              <div style={{ padding: '0 24px 24px', marginTop: -40 }}>
                ...
                >
                  ...
                  <InfoRow
                    icon={<Phone size={14} />}
                    label="Work Phone"
                    value={profile.phoneWork}
                  />
                  <InfoRow
                    icon={<Phone size={14} />}
                    label="Home Phone"
                    value={profile.phoneHome}
                  />
                  <InfoRow
                    icon={<Phone size={14} />}
                    label="Recovery"
                    value={profile.phoneRecovery}
                  />
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                {[
                  ...
                  },
                  {
                    ...
                    value: stats.totalDaysRemaining,
                    color: '#22c55e',
                  },
                ].map((row, i) => (
                  <div key={row.label}>
                        ...
                        >
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            >
                              ...
                              <span
                                style={{ margin: '0 6px', color: '#cbd5e1' }}
                              >
                                ·
                              </span>
