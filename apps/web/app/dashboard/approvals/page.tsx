...
// import { useManagerLeaveRequests } from "@/hooks/use-leave-queries";
...
//     <div
//       key={req.id}
//       className="flex flex-col gap-3 sm:flex-row sm:items-start px-5 py-4 transition-colors duration-100 cursor-default"
