...
export default function ProfilePage() {
  ...
  const { data: balances = [], isLoading: balancesLoading } =
    useUserLeaveBalances(currentUser?.id);
  ...
  const rc = roleStyle(currentUser.role);
              ...
              <div style={{ padding: '0 24px 24px', marginTop: -40 }}>
                ...
                >
                  ...
                  <InfoRow
                    icon={<Phone size={14} />}
                    label="Work Phone"
                    value={currentUser.phoneWork}
                  />
                  <InfoRow
                    icon={<Phone size={14} />}
                    label="Home Phone"
                    value={currentUser.phoneHome}
                  />
                  <InfoRow
                    icon={<Phone size={14} />}
                    label="Recovery"
                    value={currentUser.phoneRecovery}
                  />
