          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[12px] font-semibold transition-all"
                style={{
                  background: viewMode === 'weekly' ? '#6b1d0e' : 'transparent',
                ...
                >
                  {Array.from({ length: 7 }).map((_, i) => (
                    <Skeleton
                      key={i}
                      className="rounded-xl"
                      style={{ background: '#e8d5b0', minHeight: '120px' }}
                    />
                  ))}
                </div>
              ) : (
                        ...
                        {holiday && (
                          <div className="flex items-center gap-1 mt-1">
                            ...
                            <span
                              ...
                              style={{ color: '#9a3412', maxWidth: '80px' }}
                            >
                              {holiday.name}
                            </span>
                          </div>
