// /**
//  * Dashboard Header - Top bar shown on every dashboard page.
//  * Contains the sidebar toggle, breadcrumb, role switcher (for demo),
//  * and notification bell. Adapts to mobile with compact layout.
//  */
