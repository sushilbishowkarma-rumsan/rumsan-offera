...
//   }
//   // ── HR: set one leave type quota for one employee ────────────────────────────
...
//   // ── HR: set ALL leave type quotas for one employee at once ──────────────────
...
//   ) {
//     await this.leaveBalanceService.setEmployeeLeaveQuotaBulk(
//       employeeId,
//       dto.entries,
//     );
//     return { message: 'All quotas updated successfully' };
//   }
